...
Además, cuando el autovalor es positivo, el vector se expande en la misma dirección mientras que cuando el autovalor es negativo el vector se expande en la dirección opuesta.
